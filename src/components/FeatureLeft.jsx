    ...
    <section path={path} className={`flex px-0`}>
        <div className={`w-full pb-10 md:flex-col flex justify-center items-center text-white `}>
          <div className='xl:px-0 sm:px-16 flex flex-row'>
            <div className='h-56 sm:h-64 md:h-96 w-full ss:w-full md:w-full transform transform-all duration-300 shadow-purple-400/50 shadow-lg hover:shadow-xl hover:shadow-purple-400/50 flex flex-row items-center py-6 px-0 sm:px-3  bg-gradient-to-br from-purple-400/20 rounded-[10px] mb-2'>
